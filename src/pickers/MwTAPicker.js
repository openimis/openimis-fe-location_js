...
// Location1Picker.label, which the CoreMIS language pack overrides to "TA".
...
const MwTAPicker = (props) => <LocationPicker {...props} locationLevel={1} />;

export default MwTAPicker;
