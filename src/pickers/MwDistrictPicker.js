...
// Location0Picker.label, which the CoreMIS language pack overrides to "District".
...
const MwDistrictPicker = (props) => <LocationPicker {...props} locationLevel={0} />;

export default MwDistrictPicker;
