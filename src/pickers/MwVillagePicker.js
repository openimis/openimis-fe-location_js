...
// Location3Picker.label, which the CoreMIS language pack overrides to "Village".
...
const MwVillagePicker = (props) => <LocationPicker {...props} locationLevel={3} />;

export default MwVillagePicker;
